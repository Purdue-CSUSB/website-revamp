...
const accordionData = [
    ...
    //Add link to find prof here
    { title: 'How do I find a research project?', content: 'You can check out our page here to find more about all the possible opportunities available! We have listed the different <a href="researchOrgs.jsx">research orgs/programs</a> and any <a href="researchOrgs.jsx">new projects</a> available. If you want to find a project on your own, you can search up professors working in the field in which you want to and email them with your CV/Resume and a message.' },
